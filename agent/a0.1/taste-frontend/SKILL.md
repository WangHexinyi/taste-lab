...
5. **DEPTH** — use foreground/midground/background, crop, scale, overlap, material, lighting, photographic DOF, and motion relationships; glow alone is not depth.
...
Read `references/design-engines.md` for the full decision logic.
...
Do not build shaders, synth engines, physics, 3D, or elaborate effect systems while core IA, media, controls, readability, or responsiveness remain weak.
